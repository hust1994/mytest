 ...
 *
 */
public class DownloadAndExistBrowserTest extends BaseTest {

	// 当前为下载管理界面
		public void test_DownloadAndExistBrowser() {
			solo.sleep(Resource.TIME_BIG);
			Download.setUpDownload(Download.downloading_url, this);
			//有下载任务正在下载→切换到下载管理的Tab→退出下载模块，点击工具栏中的退出按钮→提示有下载任务的提示框中点击View downloads按钮???
